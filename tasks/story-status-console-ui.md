...
- Which GUI framework is the first implementation target?
...
1. task-ui-01-state-and-event-contract.md
2. task-ui-02-desktop-status-console-shell.md
3. task-ui-03-system-events-panel.md
